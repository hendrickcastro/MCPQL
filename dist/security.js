 ...
 */
export function containsModificationOperations(query) {
    if (!query)
        return false;
 ...
 */
export function validateModificationPermission(operation) {
 ...
 */
export function validateStoredProcedurePermission(spName) {
 ...
 */
export function validateQueryPermission(query) {
    if (!query) {
