    ...
    try {
        ...
        switch (toolName) {
            case 'mcp_get_sp_all_info_simple':
                result = await toolHandlers.mcp_get_sp_all_info_simple(input as any);
                break;
            case 'mcp_preview_data_enhanced':
                result = await toolHandlers.mcp_preview_data_enhanced(input as any);
                break;
            case 'mcp_get_sample_values':
                result = await toolHandlers.mcp_get_sample_values(input as any);
                break;
            case 'mcp_get_column_stats_enhanced':
                result = await toolHandlers.mcp_get_column_stats_enhanced(input as any);
                break;
            ...
            case 'mcp_search_objects_by_name':
                result = await toolHandlers.mcp_search_objects_by_name(input as any);
                break;
            case 'mcp_search_in_definitions':
                result = await toolHandlers.mcp_search_in_definitions(input as any);
                break;
            case 'mcp_search_objects_by_type':
                result = await toolHandlers.mcp_search_objects_by_type(input as any);
                break;
            case 'mcp_get_object_dependencies':
                result = await toolHandlers.mcp_get_object_dependencies(input as any);
                break;
